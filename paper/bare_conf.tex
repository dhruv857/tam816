...
\IEEEspecialpapernotice{(Draft 1)}
...
% in the abstract
\begin{abstract}
Open Source is a gift and effort of the technology community, over years creating and supporting platforms, projects etc. This paper analyzes data from GitHub public repositories available on Google's BigQuery and observes relations, trends and anomalies. To set a baseline, public repositories for 22 different languages were analyzed.
\end{abstract}
